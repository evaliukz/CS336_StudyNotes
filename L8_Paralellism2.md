...
第 8 章先不急着讲训练，而是先讲 collective operations。讲义明确说，这些是分布式编程的“概念原语”，是并行编程里很经典的一套抽象，比你自己手写点对点通信更清楚也更高效。它还先定义了两个词：
...
讲义接着讲硬件。它先拿家用环境做对比：同一台机器里的 GPU 可能走 PCIe（还是经过cpu），总线带宽比跨机器网络高很多；现代数据中心则是 GPU 之间用 NVLink 直接连，跨更多 GPU / 节点还有更复杂互连。讲义还给出一个对比：每块 H100 的 NVLink 总带宽大约 900 GB/s，而 HBM 内存带宽更高，大约 3.9 TB/s。

<img width="696" height="671" alt="image" src="https://github.com/user-attachments/assets/f53c66fe-40da-43da-a646-8b30fe3190c6" />
